...
foreach($arrayFrontera as $valor){
 ...
 $content='<table id="tabla_central" align="center" style="width:70%; font-size: 13px;" border="1" cellspacing="0" cellpadding="2" bordercolor="666633"><tr><td width="15%" height="50"><img align="center" src="https://fronteras.energiaitalener.com/vistas/img/plantilla/logo-blanco-bloque.png"  height="100" width="150"></td><td width="33%" height="50" colspan="2" style="text-align: center;"><strong>ORDEN DE SERVICIOS - BOLIVAR</strong></td> <td width="15%" height="50" align="center"><img  src="https://fronteras.energiaitalener.com/vistas/img/plantilla/logo-blanco-bloque.png"  height="100" width="100"></td><td width="15%" height="50" ><div id="span1" class="t r"><label style="text-align: center;"><strong>FP-S 001</strong></label></div><div id="span2" class="tr">Versi&oacute;n:01</div></td></tr></table>';
