...
function plantillaPdf($frontera,$total_dia_avg,$total_dia_last,$desviado,$htmlFactorM,$totalActivaMonth,$totalReactivaMonth,$totalCapacitivaMonth,$totalPerdidasMonth):string{
   ...
   <tr> 
    ...
    <tr>
    <td colspan="5" style="padding-bottom: 100px;"></td>
    </tr>
    <tr> <td colspan="5" align="center" bgcolor="#bcc1d1"><strong>FACTOR M</strong></td> 
    </tr>
    <tr> 
    <td colspan="5">En la siguiente tabla podra ver el historial de los ultimos TRES meses del factor M de su frontera</td> 
    </tr> 
    <tr> 
    ...
    <td colspan="5" style="padding-bottom: 0px;"></td>
    </tr> 
    <tr> 
    <td colspan="5" align="center" bgcolor="#bcc1d1"><strong>CONSUMO DE ENERGIAS EN EL MES</strong></td>
    </tr>
    <tr>
