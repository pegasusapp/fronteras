...
<head>
  ...
  <!-- local css -->
  <link rel="stylesheet" href="plugins/css/local.css" rel="stylesheet">
...
<script type="text/javascript" language="javascript" src="https://cdn.datatables.net/responsive/2.3.0/css/responsive.dataTables.min.css"></script>
