        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">Gráfico de area - identificador de desempeño energetico <?php echo $value["nombreFuente"];?></h3>
          ...
          <!-- /.col (LEFT) -->
                  ...
                  <!-- BAR CHART -->
                    <div class="card card-success">
                      <div class="card-header">
                        <h3 class="card-title">Gráfico de barras -  identificador de desempeño energetico <?php echo $value["nombreFuente"];?>
                        <?php
